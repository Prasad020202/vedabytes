...
const Blogs = () => {
  return (
    <section className="py-12 bg-gray-50 sm:py-16 lg:pt-20 lg:pb-40">
          ...
          <div className="flex flex-col items-center">
              ...
              <div className="relative mt-10 md:mt-24 md:order-2">
                  <div className="absolute -inset-x-1 inset-y-16 md:-inset-x-2 md:-inset-y-6">
                      <div className="w-full h-full max-w-5xl mx-auto rounded-3xl opacity-30 blur-lg filter" style={mystyle}></div>
                  </div>
                          ...
                          <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                              <div className="flex-1">
                                  ...
                                  <blockquote className="flex-1 mt-8">
                                      <p className="text-lg leading-relaxed text-gray-900 font-pj">“I am extremely satisfied with my purchase. This laptop exceeded my expectations in terms of performance, design, and portability. It strikes an excellent balance between power and sleekness. I highly recommend it to anyone seeking a reliable and high-performing laptop.”</p>
                                  </blockquote>
                              </div>

                              <div className="flex items-center mt-8">
                                  <img className="flex-shrink-0 object-cover rounded-full w-11 h-11" src="https://lh3.googleusercontent.com/a-/ALV-UjV3iVjljZ6Xop54XYa6s1sYeoYZl_cQJyL0wDXAbDm2Cw=w45-h45-p-rp-mo-br100" alt="" />
                                  <div className="ml-4">
                                      <p className="text-base font-bold text-gray-900 font-pj">Rajat D. Bagde</p>
                                      <p className="mt-0.5 text-sm font-pj text-gray-600">Verified Buyer</p>
                                  </div>
                              </div>
                          </div>
                      </div>
